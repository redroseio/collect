...
import com.redrosecps.collect.android.dao.helpers.FormsDaoHelper;
import com.redrosecps.collect.android.dao.helpers.InstancesDaoHelper;
import com.redrosecps.collect.android.events.ReadPhoneStatePermissionRxEvent;
import com.redrosecps.collect.android.events.RxEventBus;
import com.redrosecps.collect.android.exception.JavaRosaException;
import com.redrosecps.collect.android.external.ExternalDataManager;
import com.redrosecps.collect.android.formentry.FormEntryViewModel;
import com.redrosecps.collect.android.formentry.backgroundlocation.BackgroundLocationHelper;
import com.redrosecps.collect.android.formentry.backgroundlocation.BackgroundLocationManager;
import com.redrosecps.collect.android.fragments.MediaLoadingFragment;
import com.redrosecps.collect.android.fragments.dialogs.CustomDatePickerDialog;
import com.redrosecps.collect.android.fragments.dialogs.FormLoadingDialogFragment;
import com.redrosecps.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import com.redrosecps.collect.android.fragments.dialogs.NumberPickerDialog;
import com.redrosecps.collect.android.fragments.dialogs.ProgressDialogFragment;
import com.redrosecps.collect.android.fragments.dialogs.RankingWidgetDialog;
import com.redrosecps.collect.android.listeners.AdvanceToNextListener;
import com.redrosecps.collect.android.listeners.FormLoaderListener;
import com.redrosecps.collect.android.listeners.FormSavedListener;
...
import com.redrosecps.collect.android.listeners.WidgetValueChangedListener;
import com.redrosecps.collect.android.location.client.GoogleLocationClient;
import com.redrosecps.collect.android.logic.AuditEvent;
import com.redrosecps.collect.android.logic.FormController;
import com.redrosecps.collect.android.logic.FormController.FailedConstraint;
import com.redrosecps.collect.android.logic.FormInfo;
import com.redrosecps.collect.android.logic.ImmutableDisplayableQuestion;
...
import com.redrosecps.collect.android.tasks.SavePointTask;
import com.redrosecps.collect.android.tasks.SaveResult;
import com.redrosecps.collect.android.tasks.SaveToDiskTask;
import com.redrosecps.collect.android.upload.AutoSendWorker;
import com.redrosecps.collect.android.utilities.ApplicationConstants;
import com.redrosecps.collect.android.utilities.DestroyableLifecyleOwner;
...
import com.redrosecps.collect.android.utilities.RegexUtils;
import com.redrosecps.collect.android.utilities.ScreenContext;
import com.redrosecps.collect.android.utilities.SnackbarUtils;
import com.redrosecps.collect.android.utilities.SoftKeyboardUtils;
...
import static com.redrosecps.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
...
import static com.redrosecps.collect.android.utilities.PermissionUtils.areStoragePermissionsGranted;
import static com.redrosecps.collect.android.utilities.PermissionUtils.finishAllActivities;
