...
import com.redrosecps.collect.android.activities.NotificationActivity;
import com.redrosecps.collect.android.application.Collect;
import com.redrosecps.collect.android.dao.FormsDao;
import com.redrosecps.collect.android.logic.FormDetails;
...
import com.redrosecps.collect.android.utilities.NotificationUtils;
...
import static com.redrosecps.collect.android.activities.FormDownloadList.DISPLAY_ONLY_UPDATED_FORMS;
...
import static com.redrosecps.collect.android.utilities.ApplicationConstants.RequestCodes.FORM_UPDATES_AVAILABLE_NOTIFICATION;
import static com.redrosecps.collect.android.utilities.ApplicationConstants.RequestCodes.FORMS_DOWNLOADED_NOTIFICATION;
import static com.redrosecps.collect.android.utilities.DownloadFormListUtils.DL_AUTH_REQUIRED;
import static com.redrosecps.collect.android.utilities.DownloadFormListUtils.DL_ERROR_MSG;
import static com.redrosecps.collect.android.utilities.NotificationUtils.FORM_UPDATE_NOTIFICATION_ID;
...
public class ServerPollingJob extends Job {
    ...
    private void informAboutNewAvailableForms() {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(getContext(), FORM_UPDATES_AVAILABLE_NOTIFICATION, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);
    ...
    private void informAboutNewDownloadedForms(String title, HashMap<FormDetails, String> result) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(getContext(), FORMS_DOWNLOADED_NOTIFICATION, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);
