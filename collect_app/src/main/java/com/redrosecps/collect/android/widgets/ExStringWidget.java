...
public class ExStringWidget extends StringWidget implements BinaryWidget {
    ...
    public void onButtonClick(int buttonId) {
        ...
        if ("com.maviucak.android.redrose.ACTIVATE_BENEFICIARY_CARD".equals(intentName))
        {
            exParams.put("DF_KEY_KEY2", "'CA97DBE7BC6477A7EFB6C9981B1903F2'");
            exParams.put("DF_IV_KEY2", "'F638AECDF07A5A0B0100467AC25F0EA8'");
        }
